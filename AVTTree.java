 ...
 *  A table implemented using an AVL tree.
 ******************************************************************************/

import java.util.NoSuchElementException;


public class AVTTree<Value> {
    ...
    private class Node {
        ...
        public Node(int key, Value val, int height, int size) {
            this.key = key;
            this.val = val;
            this.size = size;
            this.height = height;
    ...
    public void delete(int key) {
        if (key == 0) throw new IllegalArgumentException("argument to delete() is null");
    ...
    public static void main(String[] args) {
        AVTTree<Integer> st = new AVTTree<Integer>();
